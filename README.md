...
This work is based on the PersonaGym framework proposed in the paper 'Evaluating Persona Agents and LLMs'.This repository contains an implementation / reproduction / extension of the PersonaGym evaluation framework, intended for research and educational use. It focuses on [e.g., reproducing evaluation results, experimenting with new personas, or extending rubric design].
...
- Evaluation relies on LLM-based judges and may inherit their biases.
- Persona realism depends on the fidelity of the initial persona description.
- Computational cost scales with number of personas and environments.
